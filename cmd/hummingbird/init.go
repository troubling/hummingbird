...
func initCommand(args []string) error {
	...
	if subcmd == "haio" {
		...
		print(`sudo mkdir -p /srv/hb/1/sdb1 /srv/hb/2/sdb2 /srv/hb/3/sdb3 /srv/hb/4/sdb4 /var/cache/swift /var/cache/swift2 /var/cache/swift3 /var/cache/swift4 /var/log/hummingbird /var/run/swift /var/run/hummingbird`)
		print(`sudo chmod 0755 /srv`)
