...
func initCommand(args []string) error {
	...
	case "haio":
		...
		print(`wget -nc https://dl.google.com/go/go1.10.1.linux-amd64.tar.gz`)
		print(`sudo rm -rf /usr/local/go`)
		print(`sudo tar -C /usr/local -xzf go1.10.1.linux-amd64.tar.gz`)
	...
	print(`policy_type = replication`)
	print(``)
	print(`# Disabled until we get EC metadata updates working`)
	...
	if subcmd == "haio" {
		...
		print(`sudo apt install -y python-eventlet python-mock python-netifaces python-nose python-nose-exclude python-pastedeploy python-pbr python-pyeclib python-setuptools python-swiftclient python-unittest2 python-xattr`)
