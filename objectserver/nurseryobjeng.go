...
func (o *nurseryObject) Replicate(prirep PriorityRepJob) error {
	fmt.Println("replicate call on nurseryObject: ", prirep, o.metadata)
	return nil
}
...
func (f *nurseryEngine) GetReplicationDevice(oring ring.Ring, dev *ring.Device, policy int, r *Replicator) (ReplicationDevice, error) {
