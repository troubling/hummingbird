...
func initCommand(args []string) error {
	...
	if subcmd == "haio" {
		...
		print(``)
		print(`hummingbird ring object-2.builder create 10 10 1`)
		print(`hummingbird ring object-2.builder set_nursery_replicas 3`)
		print(`hummingbird ring object-2.builder set_data_shards 6`)
		...
		print(`hummingbird ring object-2.builder add r1z1-127.0.0.1:6010R127.0.0.1:8010/sdb9 1`)
		print(`hummingbird ring object-2.builder add r1z2-127.0.0.1:6020R127.0.0.1:8020/sdb10 1`)
		print(`hummingbird ring object-2.builder add r1z3-127.0.0.1:6030R127.0.0.1:8030/sdb11 1`)
		print(`hummingbird ring object-2.builder add r1z4-127.0.0.1:6040R127.0.0.1:8040/sdb12 1`)
		print(`hummingbird ring object-2.builder add r1z1-127.0.0.1:6010R127.0.0.1:8010/sdb13 1`)
		print(`hummingbird ring object-2.builder add r1z2-127.0.0.1:6020R127.0.0.1:8020/sdb14 1`)
		print(`hummingbird ring object-2.builder add r1z3-127.0.0.1:6030R127.0.0.1:8030/sdb15 1`)
		print(`hummingbird ring object-2.builder add r1z4-127.0.0.1:6040R127.0.0.1:8040/sdb16 1`)
		...
		print(`sudo mkdir -p /var/cache/swift /var/cache/swift2 /var/cache/swift3 /var/cache/swift4 /var/log/hummingbird /var/run/swift /var/run/hummingbird`)
		print(`sudo mkdir -p /srv/hb/1/sdb1`)
		print(`sudo mkdir -p /srv/hb/2/sdb2`)
		print(`sudo mkdir -p /srv/hb/3/sdb3`)
		print(`sudo mkdir -p /srv/hb/4/sdb4`)
		print(`sudo mkdir -p /srv/hb/1/sdb5`)
		print(`sudo mkdir -p /srv/hb/2/sdb6`)
		print(`sudo mkdir -p /srv/hb/3/sdb7`)
		print(`sudo mkdir -p /srv/hb/4/sdb8`)
		print(`sudo mkdir -p /srv/hb/1/sdb9`)
		print(`sudo mkdir -p /srv/hb/2/sdb10`)
		print(`sudo mkdir -p /srv/hb/3/sdb11`)
		print(`sudo mkdir -p /srv/hb/4/sdb12`)
		print(`sudo mkdir -p /srv/hb/1/sdb13`)
		print(`sudo mkdir -p /srv/hb/2/sdb14`)
		print(`sudo mkdir -p /srv/hb/3/sdb15`)
		print(`sudo mkdir -p /srv/hb/4/sdb16`)
		print(`sudo chmod 0755 /srv`)
		print(`sudo chmod 0755 /var`)
		print(`sudo chmod 0755 /var/cache`)
		print(`sudo chmod 0755 /var/log`)
		print(`sudo chmod 0755 /var/run`)
		print(`sudo chown -R ${USER}: /srv/hb /var/cache/swift* /var/log/hummingbird /var/run/swift /var/run/hummingbird`)
		print(`if hash systemctl 2>/dev/null ; then`)
